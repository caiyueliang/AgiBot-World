...
from prismatic.vla.datasets import RLDSDataset, EpisodicRLDSDataset, RLDSBatchTransformVideo, \
                                    RLDSBatchTransformVideoMultiView
...
class LightningOpenX_MultiView(LightningDataset):
    """
    This dataset samples video recorded using a random agent
    playing the gym environments defined in the Procgen Benchmark,
    see Cobbe et al. ICML (2020).
    ...
    def __init__(
        ...
        super(LightningOpenX_MultiView, self).__init__(**kwargs)
        ...
        self.batch_transform = RLDSBatchTransformVideoMultiView(
            image_transform=transforms.ToTensor() 
        )
        self.collate_fn = CollatorForMultiViewVideo()
