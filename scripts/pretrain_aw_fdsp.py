...
class TrainConfig:
    ...
    lam_path: str = "/mnt/chenjin/AgiBot-World/logs/task_centric_lam_stage2/last.ckpt"
    ...
    # Directory Paths
    data_root_dir: str = ""  
    meta_json_dir: str = ""                               # Name of fine-tuning dataset
    ...
    wandb_project: str = "univla-awb-pretrain"                   # Name of W&B project to log to (use default!)
...
def train(cfg: TrainConfig) -> None:
    ...
    action_tokenizer = vlm.llm_backbone.get_tokenizer()
    ...
    train_strategy.run_setup(run_dir=run_dir, n_train_examples=len(dataloader))
